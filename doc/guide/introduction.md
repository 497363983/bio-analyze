...
| --- | --- | --- |
| [**Omics RNA-Seq Analysis**](../modules/bio-analyze-omics/index.md) | SRA download, QC (FastQC/fastp), Alignment (STAR), Quantification (Salmon), DE (DESeq2), Enrichment (GO/KEGG) | Fully automated pipeline, one-click HTML report, automatic reference genome handling |
