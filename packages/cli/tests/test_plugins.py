...
def test_load_typer_with_invalid_object():
    ...
    with pytest.raises(TypeError, match=r"CLI plugin must be a Typer app or a callable returning a Typer app\."):
