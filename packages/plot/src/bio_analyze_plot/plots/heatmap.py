...
class HeatmapPlot(BasePlot):
    ...
    def plot(
        ...
        **kwargs: Any,
        ...
        # 合并参数
        cmap = kwargs.get("cmap", theme_params.get("cmap", cmap))
        # 其他可能的参数，如 linecolor, linewidths 等，如果它们在 kwargs 中
        # 可以从 theme_params 注入到 kwargs
        for k, v in theme_params.items():
            if k not in kwargs and k != "cmap":
                kwargs[k] = v
