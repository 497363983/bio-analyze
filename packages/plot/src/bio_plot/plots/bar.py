        ...
        if error_bar_max and error_bar_min:
            ...
            for i, x_val in enumerate(x_vals):
                for j, hue_val in enumerate(hue_vals):
                    ...
                    ax.plot([x_center - half_cap, x_center + half_cap], [y_min, y_min], color='black', linewidth=1.5)
                    ax.plot([x_center - half_cap, x_center + half_cap], [y_max, y_max], color='black', linewidth=1.5)
